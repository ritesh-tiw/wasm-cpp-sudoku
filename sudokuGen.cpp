...
bool UsedInBox(const int grid[9][9], const int &boxStartRow, const int &boxStartCol, const int &num)
{
...
bool Sudoku::verifyGridStatus() const
{
  return grid_status;
}
...
int main(int argc, char const *argv[])
{
  ...
  cout << "The above sudoku puzzle has been stored in puzzles_sudko.svg in current folder\n";
  // freeing the memory
  delete puzzle;
